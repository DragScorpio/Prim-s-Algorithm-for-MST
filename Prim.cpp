...
Name: Xiangzhen Sun
ID: xs14
Algorithm: Prim's algorithm to find MST
Methodology:
1. Create a Min heap of Verticles-size in the given graph. Every node of min heap contains vertex number and key value of the vertex.
...
3. While Min Heap is not empty, do following
   ...
   b) For every adjacent vertex v of u, check if v is in Min Heap (not yet included in MST). If v is in Min Heap and its key value
      is more than weight of u-v, then update the key value of v as weight of u-v.
*/
#include <iostream>
#include <fstream>
#include <string>
